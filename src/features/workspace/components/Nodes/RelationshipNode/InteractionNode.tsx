        ...
        >
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              ...
              className="journal-icon-button inline-flex h-9 w-9 items-center justify-center rounded-lg transition-all border-none border-t-[var(--theme-interaction-node-journal-icon-border)] theme-light:shadow-sm theme-light:bg-white theme-light:text-[var(--theme-interaction-node-pill-text)] theme-dark:bg-[var(--theme-interaction-node-journal-icon-bg)] theme-dark:shadow-[var(--theme-interaction-node-journal-icon-shadow)] hover:scale-110"
              onMouseEnter={(e) => {
