...
const RelationshipSelectionNode = ({ id }: { id: string }) => {
  const { updateNode, setNodes } = useFlowNodesContext();
  ...
  return (
    <div className="node min-w-[200px] max-w-[280px] min-h-[120px] bg-gray-100 rounded-lg break-words px-4 py-3 flex flex-col gap-3 text-left border-2 border-gray-300">
