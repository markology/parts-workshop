/**
 * @deprecated This component is deprecated and kept for reference only.
 * Use PartNode.tsx instead, which contains the updated implementation.
 * 
 * This was the original PartNode implementation that displayed impressions
 * in a list format with 3D mapping support.
 */
...
let index = 0;
const PartNodeDeprecated = ({ data, partId }: { data: PartNodeData; partId: string }) => {
...
export default PartNodeDeprecated;
