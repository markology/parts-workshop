            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between pl-3 pr-2">
                ...
                <button
                  ...
                  className="journal-icon-button inline-flex h-9 w-9 items-center justify-center rounded-lg transition-all shadow-sm theme-dark:bg-[#924949] theme-light:bg-[rgb(206,212,255)] theme-dark:shadow-[var(--theme-button-shadow)] border-none theme-dark:border-t-[1px solid rgba(0, 0, 0, 0.15)] theme-light:border-t-[1px solid #00000012] hover:scale-110"
                  onMouseEnter={(e) => {
